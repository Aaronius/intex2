/*
 * GUIDBMConceptualVideoDisplay.java
 *
 * This class displays current conceptual videos and provides
 * navigation to add or modify conceptual videos.
 */
 ...
 *
 */
public class GUIDBMConceptualVideoDisplay extends javax.swing.JFrame {
  
  private DBMConceptualVideoController controller = new DBMConceptualVideoController(this);
  
  /** Creates new form MainFrameTransaction */
  public GUIDBMConceptualVideoDisplay() {
  ...
  private void initComponents() {
    ...
    addButton.setText("Add Conceptual Video");
    ...
    modifyButton.setText("Modify Conceptual Video");
  ...
  private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
    if (displayTable.getSelectedRow() != -1){
      GUIDBMConceptualVideoForm form = new GUIDBMConceptualVideoForm(this, controller, displayTable.getSelectedRow());
      form.setVisible(true);
    } else {
      JOptionPane.showMessageDialog(this, "You must select a conceptual video to modify.", "No Selection Made", JOptionPane.ERROR_MESSAGE);
    }
  }//GEN-LAST:event_modifyButtonActionPerformed
  
  /** Opens window for adding record */
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
    GUIDBMConceptualVideoForm form = new GUIDBMConceptualVideoForm(this, controller);
    form.setVisible(true);
