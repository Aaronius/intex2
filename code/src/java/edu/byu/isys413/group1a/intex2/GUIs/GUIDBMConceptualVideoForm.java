/*
 * GUIDBMConceptualVideoForm.java
 *
 * This class provides a form for adding or modifying a conceptual video.
 */

package edu.byu.isys413.group1a.intex2.GUIs;
import edu.byu.isys413.group1a.intex2.BOs.ConceptualVideo;
import edu.byu.isys413.group1a.intex2.Controllers.DBMConceptualVideoController;
 ...
 *
 */
public class GUIDBMConceptualVideoForm extends javax.swing.JFrame {
  
  private GUIDBMConceptualVideoDisplay display;
  private DBMConceptualVideoController controller;
  private ConceptualVideo conceptualVideo;  
  
  /** Creates new form for adding a conceptual video */
  public GUIDBMConceptualVideoForm(GUIDBMConceptualVideoDisplay display, DBMConceptualVideoController controller) {
    loadGUI();
    this.display = display;
    this.controller = controller;
    addModifyButton.setText("Add ConceptualVideo");
  ...
  /** Creates new form for modifying a conceptual video */
  public GUIDBMConceptualVideoForm(GUIDBMConceptualVideoDisplay display, DBMConceptualVideoController controller, int rowNumber) {
    loadGUI();
    this.display = display;
    this.controller = controller;
    addModifyButton.setText("Modify ConceptualVideo");
    conceptualVideo = controller.getConceptualVideoList().get(rowNumber);
    
    titleField.setText(conceptualVideo.getTitle());
  }
  ...
  private void initComponents() {
    ...
    transactionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Conceptual Video Information"));
    jLabel1.setText("Conceptual Video Name:");

    addModifyButton.setText("Add/Modify Conceptual Video");
      ...
      .add(org.jdesktop.layout.GroupLayout.TRAILING, transactionPanelLayout.createSequentialGroup()
        .add(transactionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
          ...
          .add(transactionPanelLayout.createSequentialGroup()
            ...
            .add(jLabel1)
            .add(17, 17, 17)
            .add(titleField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)))
        .add(65, 65, 65))
    );
  ...
  private void addModifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addModifyButtonActionPerformed
    ...
    if (conceptualVideo == null){ // This is a new conceptualVideo
      
      // Save the new conceptualVideo
      try{
        controller.saveConceptualVideo(titleField.getText());
      } catch(Exception e){
        JOptionPane.showMessageDialog(this, "An error occured while saving conceptual video information.", "Error Saving ConceptualVideo", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
      }
      
    } else { // This is an existing conceptualVideo
      
      // Save the modified conceptualVideo
      try{
        controller.saveConceptualVideo(conceptualVideo, titleField.getText());
      } catch(Exception e){
        JOptionPane.showMessageDialog(this, "An error occured while saving conceptual video information.", "Error Saving Conceptual Video", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
      }
    ...
    JOptionPane.showMessageDialog(this, "The conceptual video has been saved." , "Conceptual Video Saved Successfully", JOptionPane.PLAIN_MESSAGE);
