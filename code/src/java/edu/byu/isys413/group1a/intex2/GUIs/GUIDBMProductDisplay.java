/*
 * GUIDBMProductDisplay.java
 *
 * This class displays current products and provides
 * navigation to add or modify products.
 */
 ...
 *
 */
public class GUIDBMProductDisplay extends javax.swing.JFrame {
  
  private DBMProductController controller = new DBMProductController(this);
  
  /** Creates new form MainFrameTransaction */
  public GUIDBMProductDisplay() {
  ...
  private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
    if (displayTable.getSelectedRow() != -1){
      GUIDBMProductForm form = new GUIDBMProductForm(this, controller, displayTable.getSelectedRow());
      form.setVisible(true);
    } else {
      JOptionPane.showMessageDialog(this, "You must select a product to modify.", "No Selection Made", JOptionPane.ERROR_MESSAGE);
    }
  }//GEN-LAST:event_modifyButtonActionPerformed
  
  /** Opens window for adding record */
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
    GUIDBMProductForm form = new GUIDBMProductForm(this, controller);
    form.setVisible(true);
