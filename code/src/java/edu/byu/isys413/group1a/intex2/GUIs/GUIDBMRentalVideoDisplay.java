/*
 * GUIDBMRentalVideoDisplay.java
 *
 * This class displays current rental videos and provides
 * navigation to add or modify rental videos.
 */
 ...
 *
 */
public class GUIDBMRentalVideoDisplay extends javax.swing.JFrame {
  
  private DBMRentalVideoController controller = new DBMRentalVideoController(this);
  
  /** Creates new form MainFrameTransaction */
  public GUIDBMRentalVideoDisplay() {
  ...
  private void initComponents() {
    ...
    addButton.setText("Add Rental Video");
    ...
    modifyButton.setText("Modify Rental Video");
  ...
  private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
    if (displayTable.getSelectedRow() != -1){
      GUIDBMRentalVideoForm form = new GUIDBMRentalVideoForm(this, controller, displayTable.getSelectedRow());
      form.setVisible(true);
    } else {
      JOptionPane.showMessageDialog(this, "You must select a rental video to modify.", "No Selection Made", JOptionPane.ERROR_MESSAGE);
    }
  }//GEN-LAST:event_modifyButtonActionPerformed
  
  /** Opens window for adding record */
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
    GUIDBMRentalVideoForm form = new GUIDBMRentalVideoForm(this, controller);
    form.setVisible(true);
