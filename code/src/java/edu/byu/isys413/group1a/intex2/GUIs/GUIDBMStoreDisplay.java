/*
 * GUIDBMStoreDisplay.java
 *
 * This class displays current stores and provides
 * navigation to add or modify stores.
 */
 ...
 *
 */
public class GUIDBMStoreDisplay extends javax.swing.JFrame {
  
  private DBMStoreController controller = new DBMStoreController(this);
  
  /** Creates new form MainFrameTransaction */
  public GUIDBMStoreDisplay() {
  ...
  private void initComponents() {
    ...
    modifyButton.setText("Modify Store");
  ...
  private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
    if (displayTable.getSelectedRow() != -1){
      GUIDBMStoreForm form = new GUIDBMStoreForm(this, controller, displayTable.getSelectedRow());
      form.setVisible(true);
    } else {
      JOptionPane.showMessageDialog(this, "You must select a store to modify.", "No Selection Made", JOptionPane.ERROR_MESSAGE);
    }
  }//GEN-LAST:event_modifyButtonActionPerformed
  
  /** Opens window for adding record */
  private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
    GUIDBMStoreForm form = new GUIDBMStoreForm(this, controller);
    form.setVisible(true);
