/*
 * GUIDBMStoreForm.java
 *
 * This class provides a form for adding or modifying a store.
 */

package edu.byu.isys413.group1a.intex2.GUIs;
import edu.byu.isys413.group1a.intex2.BOs.Store;
import edu.byu.isys413.group1a.intex2.Controllers.DBMStoreController;
 ...
 *
 */
public class GUIDBMStoreForm extends javax.swing.JFrame {
  
  private GUIDBMStoreDisplay display;
  private DBMStoreController controller;
  private Store store;  
  
  /** Creates new form for adding a store */
  public GUIDBMStoreForm(GUIDBMStoreDisplay display, DBMStoreController controller) {
    loadGUI();
    this.display = display;
    this.controller = controller;
    addModifyButton.setText("Add Store");
  ...
  /** Creates new form for modifying a store */
  public GUIDBMStoreForm(GUIDBMStoreDisplay display, DBMStoreController controller, int rowNumber) {
    loadGUI();
    this.display = display;
    this.controller = controller;
    addModifyButton.setText("Modify Store");
    store = controller.getStoreList().get(rowNumber);
    
    nameField.setText(store.getName());
    minFeeAmountField.setText(store.getPayMinFeeAmt() + "");
  }
  ...
  private void initComponents() {
    ...
    minFeeAmountField = new javax.swing.JTextField();
    ...
    transactionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Store Information"));
    jLabel1.setText("Store Name:");

    jLabel2.setText("Minimum Fee Amount:");

    addModifyButton.setText("Add/Modify Store");
        ...
        .add(transactionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
          ...
          .add(transactionPanelLayout.createSequentialGroup()
            ...
            .add(transactionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
              .add(minFeeAmountField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
              .add(nameField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE))))
        .add(65, 65, 65))
    );
    transactionPanelLayout.setVerticalGroup(
      ...
      .add(transactionPanelLayout.createSequentialGroup()
        ...
        .add(transactionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
          .add(jLabel2)
          .add(minFeeAmountField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        .add(21, 21, 21)
        .add(transactionPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
          .add(addModifyButton)
          .add(cancelButton))
  ...
  private void addModifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addModifyButtonActionPerformed
    ...
    if (store == null){ // This is a new store
      
      // Save the new store
      try{
        controller.saveStore(nameField.getText(), minFeeAmountField.getText());
      } catch(Exception e){
        JOptionPane.showMessageDialog(this, "An error occured while saving store information.", "Error Saving Store", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
      }
      ...
      try{
        controller.saveStore(store, nameField.getText(), minFeeAmountField.getText());
      } catch(Exception e){
        JOptionPane.showMessageDialog(this, "An error occured while saving store information.", "Error Saving Store", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
      }
    ...
    JOptionPane.showMessageDialog(this, "The store has been saved." , "Store Saved Successfully", JOptionPane.PLAIN_MESSAGE);
  ...
  private javax.swing.JTextField minFeeAmountField;
